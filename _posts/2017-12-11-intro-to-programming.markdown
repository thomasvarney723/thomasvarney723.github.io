...
This works but is cumbersome. If we intend to use this same function in more than one place in our program it’s helpful to bind it to a name so that we may refer to it again.
...
You may want to do more with your function by allowing another input or two. You can add as many variables as you like and refer to them as many times as you like in the function definition. Simply include each name in the vector of inputs.
